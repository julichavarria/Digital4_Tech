window.addEventListener("load", function () {
    ...
    formulario.addEventListener("submit", function (e) {
        ...
        if (campoNombre.value == "") {
            document.querySelector("#errorNombre").innerHTML = '<i class="fa-regular fa-circle-xmark"></i> Complete su nombre ';
        ...
        if (campoApellido.value == "") {
            document.querySelector("#errorApellido").innerHTML = '<i class="fa-regular fa-circle-xmark"></i> Complete su apellido';
            document.querySelector("#apellido").classList.add("formLabelErrors");
            location.href = "#userForm";
            formErrors.push('Apellido vacio')

        } else if (campoApellido.value.length < 2) {
            document.querySelector("#errorApellido").innerHTML = '<i class="fa-regular fa-circle-xmark"></i> Debe contener mas de 2 letras';
            document.querySelector("#apellido").classList.add("formLabelErrors");
            location.href = "#userForm";
        ...
        if (campoUsuario.value == "") {
            document.querySelector("#errorUsuario").innerHTML = '<i class="fa-regular fa-circle-xmark"></i> Complete su nombre de usuario';
            ...
            document.querySelector("#errorUsuario").innerHTML = '<i class="fa-regular fa-circle-xmark"></i> Debe contener mas de 2 letras';
            document.querySelector("#usuario").classList.add("formLabelErrors");
            location.href = "#userForm";
        ...
        //VALIDACION EMAIL
        if (campoEmail.value == "") {
            document.querySelector("#errorEmail").innerHTML = '<i class="fa-regular fa-circle-xmark"></i> Complete su email';
        ...
        if (errorsPassword.length > 0) {
            ...
            document.querySelector("#errorContrasena").innerHTML = '<i class="fa-regular fa-circle-xmark"></i>';
            errorsPassword.forEach(error => document.querySelector("#errorContrasena").innerHTML += "<li>" + error + "</li>");
